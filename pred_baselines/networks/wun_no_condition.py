...
class Waveunet(nn.Module):
    ...
    def forward(self, x, track_mask=None):
        ...
        print("Input size:", curr_input_size, "Expected input size:", self.input_size)
...
class ConvLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        elif self.conv_type == "gn_leaky" or self.conv_type == "bn_leaky":
            out = F.leaky_relu(self.norm((self.filter(x))))
...
#        COND_DIM: Optional[int] = 4800,
#        COND_DIM_NEW: Optional[int] = 128,
...
#        self.num_cond = COND_DIM
#        self.num_cond_new = COND_DIM_NEW
