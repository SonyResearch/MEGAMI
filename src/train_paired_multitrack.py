...
def _main(args):
    ...
    try:
        ...
        val_loader_4 = torch.utils.data.DataLoader(dataset=val_set_4, batch_size=args.exp.val_batch_size,  collate_fn=lambda x: x)
    ...
    from training.trainer_ddp_paired_multitrack import Trainer
    #print("args", args)
