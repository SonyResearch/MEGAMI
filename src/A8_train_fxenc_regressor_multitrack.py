...
def _main(args):
    ...
    from training.trainer_fxenc_regressor_multitrack import Trainer
    #print("args", args)
    trainer = Trainer( args=args, dset=train_loader, val_set_dict=val_set_dict, network=network, device=device, distributed=False)  # This works
