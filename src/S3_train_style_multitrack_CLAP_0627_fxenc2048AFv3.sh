...
# main config
conf=conf_S3_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP.yaml

n="S3_sanity_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP"
