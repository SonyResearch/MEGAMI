...
class DistMetric:
    ...
    def __init__(self,type, sample_rate,*args, **kwargs):
        ...
        if self.type == "fx_encoder":
            ...
            self.feat_extractor = feat_extracfor_fn
        elif self.type == "fxenc2048AFv4-AF":
        ...
        if dict_y_hat is None:
            ...
            for key in dict_y.keys():
                ...
                if "AFxRep" in self.type:
                    ...
                    if self.type == "fxenc2048AFv5-fxenc++":
                        p_hat= embed_fxenc
                        #print("p_hat",p_hat.shape, p_hat.std(), "l2 norm:", p_hat.norm(p=2, dim=-1).mean())
                    elif self.type == "fxenc2048AFv5-AF":
                        p_hat= embed_AF
                ...
                elif "fxenc2048AFv4" in self.type:
                    ...
                    if self.type == "fxenc2048AFv4-fxenc++":
                        p_hat= embed_fxenc
                        #print("p_hat",p_hat.shape, p_hat.std(), "l2 norm:", p_hat.norm(p=2, dim=-1).mean())
                    elif self.type == "fxenc2048AFv4-AF":
                        p_hat= embed_AF
...
def metric_factory(metric_name, sample_rate, *args, **kwargs):
    ...
    if metric_name == "kad-fx_encoder-multitrack":
    ...
    elif metric_name == "kad-fxenc2048AFv5-fxenc++-multitrack":
        return KADFeatures(*args, **kwargs, type="fxenc2048AFv5-fxenc++", sample_rate=sample_rate)
    elif metric_name == "kad-fxenc2048AFv5-AF-multitrack":
        return KADFeatures(*args, **kwargs, type="fxenc2048AFv5-AF", sample_rate=sample_rate)
        ...
        return KADFeatures(*args, **kwargs, type="fxenc2048AFv4-AF", sample_rate=sample_rate)
    ...
    elif metric_name == "kad-class-fxenc2048AFv5-fxenc++-multitrack":
    ...
    elif metric_name == "kad-class-fxenc2048AFv4-fxenc++-multitrack":
        return KADFeatures(*args, **kwargs, type="fxenc2048AFv4-fxenc++", sample_rate=sample_rate, classwise=True)
    elif metric_name == "kad-class-fxenc2048AFv4-AF-multitrack":
        return KADFeatures(*args, **kwargs, type="fxenc2048AFv4-AF", sample_rate=sample_rate, classwise=True)
    else:
