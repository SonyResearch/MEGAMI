...
# main config
conf=conf_S1_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP.yaml

n="S1_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP"
