...
def prepare_PEQ_FDN_parameters(
    ...
    dict_transformations = {
        "peak1_gain": MinMax(-10,10),
        "peak1_freq": MinMax(200.0, 2500.0),
        "peak1_Q": MinMax(0.5, 3.0),
        "peak2_gain": MinMax(-10,10),
        "peak2_freq": MinMax(600.0, 7000.0),
        "peak2_Q": MinMax(0.5, 3.0),
        "lowshelf_gain": MinMax(-10,10),
        "lowshelf_freq": MinMax(30.0, 450.0),
        "highshelf_gain": MinMax(-10,10),
...
def prepare_PEQ_parameters(
    ...
    dict_transformations = {
        "peak1_gain": MinMax(-20,20),
        "peak1_freq": MinMax(33.0, 5400.0),
        "peak1_Q": MinMax(0.5, 10.0),
        "peak2_gain": MinMax(-20,20),
        "peak2_freq": MinMax(200.0, 17500.0),
        "peak2_Q": MinMax(0.5, 10.0),
        "lowshelf_gain": MinMax(-20,20),
        "lowshelf_freq": MinMax(30.0, 200.0),
        "highshelf_gain": MinMax(-20,20),
        "highshelf_freq": MinMax(750.0, 8300.0),
        "lowpass_freq": MinMax(10000.0, 18000.0),
        "lowpass_Q": MinMax(0.5, 10.0),
        "highpass_freq": MinMax(16.0, 500.0),
        "highpass_Q": MinMax(0.5, 10.0),
    }
