...
def _main(args):
    ...
    try:
        ...
        val_loader_3 = torch.utils.data.DataLoader(dataset=val_set_3, batch_size=args.exp.val_batch_size)
    ...
    from testing.tester_mapper_loud import Tester
    import copy
    ...
    from training.trainer_mapper_blackbox_predictive_loud import Trainer
    #print("args", args)
    trainer = Trainer( args=args, dset=train_loader, network=network, device=device, tester=tester, distributed=False)  # This works
