...
# main config
conf=conf_S8_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="S8_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor"
