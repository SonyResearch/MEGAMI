...
class Trainer():
    ...
    def train_step(self):
        ...
        error, sigma, x_norm, y = self.diff_params.loss_fn(self.network, sample=y, context=x, ema=self.ema, clusters=None, taxonomy=taxonomy, masks=masks, compile=self.args.exp.compile)
