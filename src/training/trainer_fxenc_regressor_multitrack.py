...
class Trainer():
    ...
    def train_step(self):
        ...
        x, y, taxonomy, masks = self.get_batch()
        ...
        with torch.no_grad():
            ...
            #print("x shape", x.shape, "y shape", y.shape    )
            x_encoded = self.encode(x)  # encode x with CLAP encoder
            y_encoded = self.encode(y)  # encode y with CLAP encoder
