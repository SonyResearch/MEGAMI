...
# main config
conf=conf_tencymastering_multitrack_simulated_styleAFxrep_contentCLAP_notaxonomy_projection.yaml

n="tencymastering_multitrack_simulated_styleAFxRep_contentCLAP_randomorder_notaxonomy_projection"
