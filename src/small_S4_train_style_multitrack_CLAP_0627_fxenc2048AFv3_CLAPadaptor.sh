...
# main config
conf=conf_smallS4_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="smallS4_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor"
