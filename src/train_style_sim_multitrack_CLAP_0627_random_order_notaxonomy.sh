...
# main config
conf=conf_tencymastering_multitrack_simulated_styleAFxrep_contentCLAP_notaxonomy.yaml

n="tencymastering_multitrack_simulated_styleAFxRep_contentCLAP_randomorder_notaxonomy"
