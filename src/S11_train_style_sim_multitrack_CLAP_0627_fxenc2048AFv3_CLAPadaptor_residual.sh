...
# main config
conf=conf_S11_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="S11_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor"
