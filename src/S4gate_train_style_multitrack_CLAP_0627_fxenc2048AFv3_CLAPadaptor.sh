...
# main config
conf=conf_S4gate_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="S4gate_tencymastering_multitrack_paired_stylefxenc2048AF_contentCLAP_CLAPadaptor"
