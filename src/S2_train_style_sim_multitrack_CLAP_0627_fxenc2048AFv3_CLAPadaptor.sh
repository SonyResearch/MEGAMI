...
# main config
conf=conf_S2_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="S2_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor"
