...
python test.py --config-name=$conf  \
  ...
  diff_params.effect_randomizer_comp_test.range_log_ratio=[0,0] \
  diff_params.effect_randomizer_comp_test.range_log_threshold=[-5,-5] \
  diff_params.effect_randomizer_comp_test.range_z_alpha_pre=[3,3] \
  diff_params.effect_randomizer_comp_test.range_z_alpha_post=[3,3] \
  ...
  tester.wandb.tags="[\"cond:randomfx\",\"model:M2L4DiT\",\"traindata:TMrandomfx\",\"its:500k\",\"cfg:2\",\"T60:0.1\",\"compressed_ratio_0_thresh-5\",\"SNR:0\"]" \
