...
# main config
conf=conf_1C_tencymastering_vocals_simulated_countrypop_style_CLAP_abspos.yaml


n="1C_tencymastering_vocals_style_sim_countrypop_2306_CLAP_abspos_drywet_normal"
...
python train_sim.py --config-name=$conf  \
  ...
  network=Latent_DiT_M2L4_crossatt_catabspos_normal
