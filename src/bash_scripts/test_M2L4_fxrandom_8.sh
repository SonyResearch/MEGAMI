...
python test.py --config-name=$conf  \
  ...
  diff_params.effect_randomizer_comp_test.RMS_mean=-20 \
  ...
  tester.wandb.tags="[\"cond:randomfx\",\"model:M2L4DiT\",\"traindata:TMrandomfx\",\"its:500k\",\"cfg:2\",\"T60:0.1\",\"no_compressed\",\"SNR:0\",\"RMS=-20\"]" \
