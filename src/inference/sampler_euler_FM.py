...
class SamplerEulerFM(Sampler):
    ...
    def step(self, x_i, t_i, t_iplus1):
        ...
        with torch.no_grad():
            ...
            v=self.diff_params.model_call(x_i,self.model, t_i, cond=self.cond, cfg_scale=self.cfg_scale)
    ...
    def create_schedule(self, sigma_min=None, sigma_max=None, rho=None, T=None):
        ...
        t = torch.linspace(self.diff_params.t_max, self.diff_params.t_min, T+1)
        return t
