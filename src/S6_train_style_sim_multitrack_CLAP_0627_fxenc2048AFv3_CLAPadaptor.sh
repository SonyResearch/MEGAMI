...
# main config
conf=conf_S6_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor.yaml

n="S6_tencymastering_multitrack_simulated_stylefxenc2048AF_contentCLAP_CLAPadaptor"
