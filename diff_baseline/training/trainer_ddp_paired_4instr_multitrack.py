...
class Trainer():
    ...
    def get_batch(self):
        ...
        y=y.to(self.device)  # y is a tensor of shape [B, N
    ...
    def train_step(self):
        ...
        error, sigma = self.diff_params.loss_fn(self.network, sample=y, context=x, ema=self.ema, compile=self.args.exp.compile)
